...
def bezformata_msk_parser():
    print(f'bezformata_msk job started at {datetime.datetime.now()}')
    page = 1
    while True:
        url = 'https://moskva.bezformata.com/daynews/'
        ...
        if r.status_code != 200:
            print(
                f'bezformata_msk job error, request status code != 200\n'
                f'url: {r.url}\n'
        ...
        if not news_data:
            print(f'bezformata_msk job ended at {datetime.datetime.now()}')
            return
